    ...
    return (
       <div className="relative flex">
          ...
          rounded-br-3xl px-[9vmin] py-[0.7vmin]
           border-4 border-gray-200 shadow-2xl shadow-black
        ...
        shadow-2xl shadow-black border-[0.4rem] border-orange-500
        rounded-br-3xl
        flex flex-col text-[3vmin] font-bold text-yellow-200">
